...
<div class="lockscreen-wrapper">
  ...
  <div class="help-block text-center">
    <div class="callout callout-success">
      ...
      <p>Tente fazer o login com sua nova senha.<br><a href="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>admin/login">Clique aqui</a> para fazer o login.</p>
    </div>
  </div>
