...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?php echo $url_base; ?>res/site/css/bootstrap.min.css">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo $url_base; ?>res/site/css/font-awesome.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo $url_base; ?>res/site/css/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo $url_base; ?>res/site/css/style.css">
    <link rel="stylesheet" href="<?php echo $url_base; ?>res/site/css/responsive.css">
