...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>res/admin/index2.html"><b>Admin</b>LTE</a>
  </div>
  ...
  <div class="lockscreen-item">
    ...
    <form  action="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>admin/forgot" method="post">
  ...
  <div class="text-center">
    <a href="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>admin/login">Or sign in as a different user</a>
  </div>
