            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="product-breadcroumb">
                        <a href="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>">Home</a>
                        <a href="<?php echo htmlspecialchars( $url_base, ENT_COMPAT, 'UTF-8', FALSE ); ?>product/<?php echo htmlspecialchars( $product["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $product["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-category">
                                    <p>Categorias: {autoescape="off"}<?php echo htmlspecialchars( $categories, ENT_COMPAT, 'UTF-8', FALSE ); ?>{/autoescape}
                                </div> 
