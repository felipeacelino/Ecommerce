...
class User extends Model {
    ...
    public static function getPageSearch($search, $page = 1, $itemsPerPage = 10) {
        ...
        $results = $sql->select("SELECT SQL_CALC_FOUND_ROWS * FROM tb_users a INNER JOIN tb_persons b USING(idperson) WHERE b.desperson LIKE :search OR b.desemail = :search OR a.deslogin LIKE :search ORDER BY b.desperson LIMIT $start, $itemsPerPage", array(
            ":search" => '%'.$search.'%'
        ));
