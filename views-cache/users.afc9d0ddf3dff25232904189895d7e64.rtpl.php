...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo $url_base; ?>admin/users">Usuários</a></li>
  </ol>
</section>
  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              <a href="<?php echo $url_base; ?>admin/users/create" class="btn btn-success">Cadastrar Usuário</a>
              <div class="box-tools">
                <form action="<?php echo $url_base; ?>admin/users">
