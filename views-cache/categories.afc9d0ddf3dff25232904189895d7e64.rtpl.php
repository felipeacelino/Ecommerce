  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <form action="<?php echo $url_base; ?>admin/categories">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?php echo $url_base; ?>admin/categories/<?php echo $value1["idcategory"]; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
