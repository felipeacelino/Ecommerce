    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="<?php echo $url_base; ?>res/site/img/logo.png" alt="Logo">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '<?php echo $url_base; ?>admin/orders/<?php echo $order["idorder"]; ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
                    <i class="fa fa-pencil"></i> Editar Status
                </button>
                <button type="button" onclick="window.open('<?php echo $url_base; ?>boleto/<?php echo $order["idstatus"]; ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
