        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center">
                    <h2><?php echo $product["desproduct"]; ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="product-breadcroumb">
                        ...
                        <a href="<?php echo $url_base; ?>product/<?php echo $product["desurl"]; ?>"><?php echo $product["desproduct"]; ?></a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <form action="<?php echo $url_base; ?>cart/<?php echo $product["idproduct"]; ?>/add" class="cart">
                                    <div class="quantity">
                                ...
                                <div class="product-inner-category">
                                    <p>Categorias: <?php echo $categories; ?>
